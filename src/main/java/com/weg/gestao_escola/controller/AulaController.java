...
public class AulaController {
    ...
    @PostMapping
    public ResponseEntity<AulaRespostaDTO> criar(@Valid @RequestBody AulaRequisicaoDTO requisicaoDTO){
        try{
    ...
    @PutMapping("/{id}")
    public ResponseEntity<AulaRespostaDTO> atualizar(@Valid @PathVariable int id,
